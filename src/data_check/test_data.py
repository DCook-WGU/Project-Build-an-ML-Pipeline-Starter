...
def test_row_count(data: pd.DataFrame):
    ...
    """
    Test if dataset is over an appropriate size, not too small and not too large. 
    
    Args:
        data: Current dataset to test
        
    Raises:
        AssertionError: If row count is less than 15,000 and greater than 1,000,000
    """
...
def test_price_range(data: pd.DataFrame, min_price: float, max_price: float):
    """
    Test if price is within the defined range.
